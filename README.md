![image](https://github.com/user-attachments/assets/f24a4458-d49c-4554-8845-0ae625bfbdd1)![image](https://github.com/user-attachments/assets/aab4ff80-b4fc-44d1-8f11-ef9112bdd25b)# Web Programming 프로젝트
...
**깃허브 주소**: [Web Programming Project](https://github.com/Sean-Kim831/2024_Interation_Web_Project)

## 프로젝트 동기

**현황파악**: 
- 강원특별자치도는 아름다운 자연과 다양한 체험 및 문화 지역으로서의 강점을 가지고 있다. <br>
하지만 강원도에 거주하지 않는 사람은 강원도를 깊숙이 알고 있지 못하고, 심지어 강원도민이어도 곳곳을 다녀보지 못한 경우도 많다.<br>
강원도 18개의 시와 군의 정보를 알고 싶은 수요가 있는 유저는 각각의 지방자치 홈페이지를 접속해야한다. 한번에 보고 접근할 수 있는 도메인이 없는 상황이다.

**최신 정보 및 기존 현황**:  
- 강원특별자치도 내 서비스 통합 플랫폼 존재 -> "우리도", "나야나" 앱 서비스
- 하지만, 사용미약 ( 단조로운 UI, 인터랙션 요소의 한계 등)
